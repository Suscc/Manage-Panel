import {
  ...
  Pipe, PipeTransform, HostBinding, HostListener
} from '@angular/core';
...
export class Index implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    this.eventQueue.push(environment.handlerAPI, AdminUsers.detail({ "d_Token": localStorage.getItem('userToken') }), 'post', test);
